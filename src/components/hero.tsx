    ...
    >
      <div className="relative mx-auto grid w-full max-w-5xl grid-cols-1 items-center gap-10 px-5 sm:px-8 md:grid-cols-[1.4fr_1fr]">
        ...
        >
          ...
          <motion.p variants={item} className="mt-3 text-lg sm:text-xl">
            {profile.role}
          </motion.p>
          ...
          <motion.div
            variants={item}
            className="mt-7 flex items-center gap-3 text-muted"
          >
        ...
        >
          ...
          <div
            className="absolute -bottom-3 -right-3 h-full w-full rounded-[1.75rem] border border-accent/40"
            aria-hidden
          />
