...
export function Experience() {
  return (
    <Section
      ...
      description="The teams and companies I've built with — from apprenticeship and training programs to leading front-end development on enterprise products. Expand any role to see the detail."
    >
...
function ExperienceCard({
  ...
  return (
    <SpotlightCard className="rounded-2xl">
      <article className="group relative overflow-hidden rounded-2xl border border-border bg-surface p-6 transition-[border-color,box-shadow] duration-300 hover:border-accent/50 hover:shadow-lg sm:p-8">
        ...
        <div className="mt-5 flex items-center gap-4">
          ...
          {/* Hairline that grows toward the badge as the card opens */}
          <span
            aria-hidden
            className={`h-px flex-1 origin-left bg-gradient-to-r from-accent/40 to-transparent transition-transform duration-500 ${
